...
#warning "Dwell timer resolution is higher than the dwell timer ticks"
  ...
  #define LED_MANUAL_PWM_BLINK()       do { user_interface.LED_manual_pwm.blink_off_time = 150; user_interface.LED_manual_pwm.blink_period = 300; } while(0)
  #define LED_MANUAL_PWM_BAD_REQEST_BLINK()       do { user_interface.LED_manual_pwm.blink_off_time = 50; user_interface.LED_manual_pwm.blink_period = 100; } while(0)
