...
#define BITFLAG_AUTO_ATX_ENABLE    bit(BIT_AUTO_ATX_ENABLE)
...
typedef struct {
  ...
  gpioport_t step_invert_mask;
  gpioport_t dir_invert_mask;
...
gpioport_t get_step_pin_mask(uint8_t i);

// Returns the direction pin mask according to Grbl's internal axis numbering
gpioport_t get_direction_pin_mask(uint8_t i);

// Returns the limit pin mask according to Grbl's internal axis numbering
gpioport_t get_limit_pin_mask(uint8_t i);
